  ...
  return (
    <section id="home" className="bg-gray-20 gap-16 py-10 md:h-full md:pb-0 ">
      ...
      >
        ...
        "
        >
          <img alt="grapic" src={HomePageGraphic} />
        </div>
      </motion.div>
      {isAboveMediumScreen && (
        <div className="h-[150px] w-full bg-primary-100 py-10">
          <div className="mx-auto w-5/6">
            <div className="flex w-3/5 items-center justify-between gap-8">
              <img alt="sponser-redbull" src={SponsorRedBull} />
              <img alt="sponser-forbes" src={SponsorForbes} />
              <img alt="sponser-fortune" src={SponsorFortune} />
            </div>
          </div>
        </div>
      )}
